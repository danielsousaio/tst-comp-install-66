"""
Django settings for tst_comp_install_66 project.
...
ROOT_URLCONF = 'tst_comp_install_66.urls'
...
WSGI_APPLICATION = 'tst_comp_install_66.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_comp_install_66 API",
    "DESCRIPTION": "API documentation for tst_comp_install_66 App",
    "VERSION": "v1",
}
